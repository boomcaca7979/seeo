...
export interface BacklinkSummary {
  ...
  dofollowRatio: number; // 0-1
  newTrend: { d: string; v: number }[];
  lostTrend: { d: string; v: number }[];
}
...
export interface AnchorDist {
  type: string;
  count: number;
  ratio: number; // 0-1
}

export const backlinkSummary: BacklinkSummary = {
  totalBacklinks: 192847,
  refDomains: 1927,
  authorityScore: 76,
  dofollowRatio: 0.68,
  newTrend: Array.from({ length: 90 }, (_, i) => ({
    d: `D${i + 1}`,
    v: 30 + Math.round(Math.abs(Math.sin(i / 5)) * 60) + (i > 60 ? 20 : 0),
  })),
  lostTrend: Array.from({ length: 90 }, (_, i) => ({
    d: `D${i + 1}`,
    v: 15 + Math.round(Math.abs(Math.cos(i / 4)) * 30),
  })),
};

export const backlinkRows: BacklinkRow[] = [
  { sourceUrl: "blog.example.com/seo-guide", anchor: "SEO 工具对比", targetUrl: "example.com/tools", authority: 82, dofollow: true, firstSeen: "2026-07-12" },
  { sourceUrl: "news.tech.com/article/123", anchor: "最好的 SEO 工具", targetUrl: "example.com/", authority: 71, dofollow: true, firstSeen: "2026-07-08" },
  { sourceUrl: "forum.webmaster.cn/t/456", anchor: "点击这里", targetUrl: "example.com/features", authority: 38, dofollow: false, firstSeen: "2026-07-05" },
  { sourceUrl: "docs.partner.io/refs", anchor: "SeeO", targetUrl: "example.com/", authority: 65, dofollow: true, firstSeen: "2026-06-29" },
  { sourceUrl: "medium.com/@author/post", anchor: "关键词研究工具", targetUrl: "example.com/keywords", authority: 54, dofollow: false, firstSeen: "2026-06-22" },
  { sourceUrl: "github.com/user/repo", anchor: "example.com", targetUrl: "example.com/", authority: 89, dofollow: true, firstSeen: "2026-06-18" },
  { sourceUrl: "zhihu.com/question/789", anchor: "网站分析工具推荐", targetUrl: "example.com/features", authority: 48, dofollow: false, firstSeen: "2026-06-10" },
  { sourceUrl: "dev.to/team/seo-stack", anchor: "排名追踪", targetUrl: "example.com/rank", authority: 62, dofollow: true, firstSeen: "2026-06-05" },
];

export const refDomainRows: RefDomainRow[] = [
  { domain: "github.com", authority: 89, backlinks: 14, industry: "科技", country: "美国", language: "英文" },
  { domain: "blog.example.com", authority: 82, backlinks: 9, industry: "营销", country: "中国", language: "中文" },
  { domain: "news.tech.com", authority: 71, backlinks: 6, industry: "科技", country: "美国", language: "英文" },
  { domain: "docs.partner.io", authority: 65, backlinks: 4, industry: "SaaS", country: "德国", language: "英文" },
  { domain: "dev.to", authority: 62, backlinks: 3, industry: "科技", country: "美国", language: "英文" },
  { domain: "medium.com", authority: 54, backlinks: 2, industry: "媒体", country: "美国", language: "英文" },
  { domain: "zhihu.com", authority: 48, backlinks: 5, industry: "问答", country: "中国", language: "中文" },
  { domain: "forum.webmaster.cn", authority: 38, backlinks: 1, industry: "论坛", country: "中国", language: "中文" },
];

export const anchorDist: AnchorDist[] = [
  { type: "品牌词", count: 842, ratio: 0.44 },
  { type: "精确匹配", count: 376, ratio: 0.20 },
  { type: "泛匹配", count: 289, ratio: 0.15 },
  { type: "裸 URL", count: 231, ratio: 0.12 },
  { type: "其他", count: 190, ratio: 0.09 },
];
