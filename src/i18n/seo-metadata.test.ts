...
const PAGES: Record<"en" | "zh", Record<string, MetaEntry>> = {
  en: {
    ...
    "/features/keyword-research": enMeta.keywordResearch,
    "/features/competitor-analysis": enMeta.competitorAnalysis,
    "/features/content-optimization": enMeta.contentOptimization,
    "/alternatives/semrush": enMeta.alternativesSemrush,
    "/alternatives/ahrefs": enMeta.alternativesAhrefs,
    "/guides/how-to-do-a-technical-seo-audit": enMeta.guideTechnicalSeoAudit,
    "/guides/how-to-track-keyword-rankings": enMeta.guideKeywordRankings,
    "/guides/how-to-analyze-backlinks": enMeta.guideBacklinkAnalysis,
    "/tools/backlink-checker": enMeta.backlinkChecker,
  ...
  zh: {
    ...
    "/zh/features/keyword-research": zhMeta.keywordResearch,
    "/zh/features/competitor-analysis": zhMeta.competitorAnalysis,
    "/zh/features/content-optimization": zhMeta.contentOptimization,
    "/zh/alternatives/semrush": zhMeta.alternativesSemrush,
    "/zh/alternatives/ahrefs": zhMeta.alternativesAhrefs,
    "/zh/guides/how-to-do-a-technical-seo-audit": zhMeta.guideTechnicalSeoAudit,
    "/zh/guides/how-to-track-keyword-rankings": zhMeta.guideKeywordRankings,
    "/zh/guides/how-to-analyze-backlinks": zhMeta.guideBacklinkAnalysis,
    "/zh/tools/backlink-checker": zhMeta.backlinkChecker,
